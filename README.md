...
From a button handler, print the current WebView to open the system print UI: [Print WebView](https://docs.rdlabo.dev/projects/capacitor-printer/docs/web). Print a real local PDF or other file with [Print PDF and files](https://docs.rdlabo.dev/projects/capacitor-printer/docs/pdf).
